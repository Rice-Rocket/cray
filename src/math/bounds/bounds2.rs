...
impl<T: Numeric + Clone + Copy> TBounds2<T> {
    ...
    pub fn union_box(self, rhs: Self) -> Self {
        Self {
            min: TVec2::new(self.min.x.nmin(rhs.min.x), self.min.y.nmin(rhs.min.y)),
            max: TVec2::new(self.max.x.nmax(rhs.max.x), self.max.y.nmax(rhs.max.y)),
        }
    }

    fn union_box_assign(&mut self, rhs: Self) {
        self.min = TVec2::new(self.min.x.nmin(rhs.min.x), self.min.y.nmin(rhs.min.y));
        self.max = TVec2::new(self.max.x.nmax(rhs.max.x), self.max.y.nmax(rhs.max.y));
    }
    ...
    pub fn union_vect(self, rhs: TVec2<T>) -> Self {
        Self {
            min: TVec2::new(self.min.x.nmin(rhs.x), self.min.y.nmin(rhs.y)),
            max: TVec2::new(self.max.x.nmax(rhs.x), self.max.y.nmax(rhs.y)),
        }
    }

    fn union_vect_assign(&mut self, rhs: TVec2<T>) {
        self.min = TVec2::new(self.min.x.nmin(rhs.x), self.min.y.nmin(rhs.y));
        self.max = TVec2::new(self.max.x.nmax(rhs.x), self.max.y.nmax(rhs.y));
    }
    ...
    pub fn intersect(self, rhs: Self) -> Self {
        Self {
            min: TVec2::new(self.min.x.nmax(rhs.min.x), self.min.y.nmax(rhs.min.y)),
            max: TVec2::new(self.max.x.nmin(rhs.max.x), self.max.y.nmin(rhs.max.y)),
        }
    }

    fn intersect_assign(&mut self, rhs: Self) {
        self.min = TVec2::new(self.min.x.nmax(rhs.min.x), self.min.y.nmax(rhs.min.y));
        self.max = TVec2::new(self.max.x.nmin(rhs.max.x), self.max.y.nmin(rhs.max.y));
    }
}
