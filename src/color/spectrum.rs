...
impl Spectrum {
    ...
    pub fn get_named_spectrum(spectrum: NamedSpectrum) -> Arc<Spectrum> {
        ...
        match spectrum {
            ...
            NamedSpectrum::GlassFk51A => Lazy::force(&GLASS_FK51A_ETA).clone(),
            NamedSpectrum::GlassLasF9 => Lazy::force(&GLASS_LASF9_ETA).clone(),
            NamedSpectrum::GlassF5 => Lazy::force(&GLASS_F5_ETA).clone(),
            NamedSpectrum::GlasF10 => Lazy::force(&GLASS_F10_ETA).clone(),
            ...
            NamedSpectrum::CuZnEta => Lazy::force(&CUZN_ETA).clone(),
            NamedSpectrum::CuZnK => Lazy::force(&CUZN_K).clone(),
            NamedSpectrum::MgOEta => Lazy::force(&MGO_ETA).clone(),
            NamedSpectrum::MgOK => Lazy::force(&MGO_K).clone(),
            NamedSpectrum::TiO2Eta => Lazy::force(&TIO2_ETA).clone(),
            NamedSpectrum::TiO2K => Lazy::force(&TIO2_K).clone(),
            NamedSpectrum::StdIllumA => Lazy::force(&STD_ILLUM_A).clone(),
            NamedSpectrum::StdIllumD50 => Lazy::force(&STD_ILLUM_D50).clone(),
            NamedSpectrum::StdIllumD65 => Lazy::force(&STD_ILLUM_D65).clone(),
            NamedSpectrum::StdIllumF1 => Lazy::force(&STD_ILLUM_F1).clone(),
            NamedSpectrum::StdIllumF2 => Lazy::force(&STD_ILLUM_F2).clone(),
            NamedSpectrum::StdIllumF3 => Lazy::force(&STD_ILLUM_F3).clone(),
            NamedSpectrum::StdIllumF4 => Lazy::force(&STD_ILLUM_F4).clone(),
            NamedSpectrum::StdIllumF5 => Lazy::force(&STD_ILLUM_F5).clone(),
            NamedSpectrum::StdIllumF6 => Lazy::force(&STD_ILLUM_F6).clone(),
            NamedSpectrum::StdIllumF7 => Lazy::force(&STD_ILLUM_F7).clone(),
            NamedSpectrum::StdIllumF8 => Lazy::force(&STD_ILLUM_F8).clone(),
            NamedSpectrum::StdIllumF9 => Lazy::force(&STD_ILLUM_F9).clone(),
            NamedSpectrum::StdIllumF10 => Lazy::force(&STD_ILLUM_F10).clone(),
            NamedSpectrum::StdIllumF11 => Lazy::force(&STD_ILLUM_F11).clone(),
            NamedSpectrum::StdIllumF12 => Lazy::force(&STD_ILLUM_F12).clone(),
